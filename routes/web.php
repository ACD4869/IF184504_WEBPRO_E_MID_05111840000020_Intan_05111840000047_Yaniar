...
Route::group(['middleware' => ['auth','checkRole:staff']], function(){
  ...
  Route::get('/returns',[ReturningController::class, 'index']);
  Route::post('/returns/{id}/now',[ReturningController::class, 'returnNow']);
...
Route::group(['middleware' => ['auth','checkRole:member']], function(){
  ...
  Route::get('/borrow/history',[BorrowController::class, 'myHistory']);
});
